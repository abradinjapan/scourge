#ifndef SCOURGE__compiler__specifications
...
typedef enum COMPILER__ptt {
    ...
    // type definitions
    COMPILER__ptt__scourge_cell = COMPILER__ptt__START,
    COMPILER__ptt__scourge_buffer,
    COMPILER__ptt__scourge_current,
    COMPILER__ptt__scourge_time,
    COMPILER__ptt__scourge_compiler__settings,
    COMPILER__ptt__scourge_compiler__debug_information,
    COMPILER__ptt__scourge_compiler__error,
    COMPILER__ptt__scourge_text_location,
...
COMPILER__blueprintling COMPILER__global__predefined_types[] = {
    ...
    COMPILER__abt__define_type,
        COMPILER__ptt__scourge_buffer,
        2,
        COMPILER__ptt__scourge_cell, // start
            COMPILER__ptmnt__start,
        COMPILER__ptt__scourge_cell, // end
            COMPILER__ptmnt__end,
    // current
    COMPILER__abt__define_type,
        COMPILER__ptt__scourge_current,
...
COMPILER__blueprintling COMPILER__global__predefined_one_off_function_calls[] = {
    ...
    COMPILER__abt__define_function_call,
        ...
        1,
        COMPILER__aat__COUNT + COMPILER__ptt__scourge_cell,
    ...
    COMPILER__abt__define_function_call,
        ...
        1,
        COMPILER__aat__COUNT + COMPILER__ptt__scourge_buffer,
    ...
    COMPILER__abt__define_function_call,
        ...
        2,
        COMPILER__aat__COUNT + COMPILER__ptt__scourge_buffer,
        COMPILER__aat__COUNT + COMPILER__ptt__scourge_compiler__settings,
        3,
        COMPILER__aat__COUNT + COMPILER__ptt__scourge_buffer,
        COMPILER__aat__COUNT + COMPILER__ptt__scourge_compiler__debug_information,
        COMPILER__aat__COUNT + COMPILER__ptt__scourge_compiler__error,
    ...
    COMPILER__abt__define_function_call,
        ...
        0,
        1,
        COMPILER__aat__COUNT + COMPILER__ptt__scourge_time,
