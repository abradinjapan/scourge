#ifndef SCOURGE__compiler__parser
#define SCOURGE__compiler__parser
...
typedef struct COMPILER__namespace {
    SAILOR__counted_list lexlings; // COMPILER__lexling
} COMPILER__namespace;

// create name
COMPILER__namespace COMPILER__create__namespace(SAILOR__counted_list lexlings) {
...
COMPILER__namespace COMPILER__create_null__namespace() {
    return COMPILER__create__namespace(SAILOR__create_null__counted_list());
}
...
SAILOR__bt COMPILER__check__identical_namespaces(COMPILER__namespace a, COMPILER__namespace b) {
    SAILOR__current current_namespace_a = SAILOR__calculate__current_from_list_filled_index(&a.lexlings.list);
    SAILOR__current current_namespace_b = SAILOR__calculate__current_from_list_filled_index(&b.lexlings.list);
    ...
    while (SAILOR__check__current_within_range(current_namespace_a) && SAILOR__check__current_within_range(current_namespace_b)) {
        // check name equivalency
        if (SAILOR__calculate__buffer_contents_equal((*(COMPILER__lexling*)current_namespace_a.start).value, (*(COMPILER__lexling*)current_namespace_b.start).value) == SAILOR__bt__false) {
            // not equivalent
            return SAILOR__bt__false;
        }
...
SAILOR__bt COMPILER__check__empty_namespace(COMPILER__namespace name) {
...
SAILOR__bt COMPILER__check__namespace_against_c_string(const char* string, COMPILER__namespace checking) {
    ...
    temp_name.lexlings.list = SAILOR__create__list(SAILOR__create__buffer((SAILOR__address)&temp_lexling, (SAILOR__address)(&temp_lexling) + sizeof(temp_lexling) - 1), sizeof(temp_lexling) - 1, sizeof(temp_lexling));
...
COMPILER__parsling_argument COMPILER__get__parsling_argument_by_index(SAILOR__counted_list arguments, COMPILER__argument_index index) {
    // return find
...
typedef struct COMPILER__parsling_scope {
    SAILOR__counted_list statements; // COMPILER__parsling_statement
} COMPILER__parsling_scope;

// create custom scope
COMPILER__parsling_scope COMPILER__create__parsling_scope(SAILOR__counted_list statements) {
...
COMPILER__parsling_scope COMPILER__create_null__parsling_scope() {
    // return empty
    return COMPILER__create__parsling_scope(SAILOR__create_null__counted_list());
}
...
typedef struct COMPILER__parsling_statement {
    ...
    // function call data
    SAILOR__counted_list inputs; // COMPILER__parsling_argument
    SAILOR__counted_list outputs; // COMPILER__parsling_argument
...
COMPILER__parsling_statement COMPILER__create__parsling_statement(COMPILER__stt type, COMPILER__parsling_argument name, SAILOR__counted_list inputs, SAILOR__counted_list outputs, COMPILER__parsling_argument subscope_flag_name, COMPILER__parsling_scope subscope) {
...
COMPILER__parsling_statement COMPILER__create_null__parsling_statement() {
    // return empty
    return COMPILER__create__parsling_statement(COMPILER__stt__invalid, COMPILER__create_null__parsling_argument(), SAILOR__create_null__counted_list(), SAILOR__create_null__counted_list(), COMPILER__create_null__parsling_argument(), COMPILER__create_null__parsling_scope());
}

// one structure
typedef struct COMPILER__parsling_structure {
    SAILOR__counted_list type_names; // COMPILER__parsling_argument
    SAILOR__counted_list arguments; // COMPILER__parsling_argument
} COMPILER__parsling_structure;

// create a custom structure
COMPILER__parsling_structure COMPILER__create__parsling_structure(SAILOR__counted_list type_names, SAILOR__counted_list arguments) {
...
COMPILER__parsling_structure COMPILER__create_null__parsling_structure() {
    // return empty
    return COMPILER__create__parsling_structure(SAILOR__create_null__counted_list(), SAILOR__create_null__counted_list());
}
...
typedef struct COMPILER__parsling_program {
    SAILOR__counted_list functions; // COMPILER__parsling_function
    SAILOR__counted_list structures; // COMPILER__parsling_structure
} COMPILER__parsling_program;

// create a custom program
COMPILER__parsling_program COMPILER__create__parsling_program(SAILOR__counted_list functions, SAILOR__counted_list structures) {
...
COMPILER__parsling_program COMPILER__create_null__parsling_program() {
    // return empty
    return COMPILER__create__parsling_program(SAILOR__create_null__counted_list(), SAILOR__create_null__counted_list());
}

// append namespace
void COMPILER__append__namespace(SAILOR__list* list, COMPILER__namespace data, COMPILER__error* error) {
    // request space
    SAILOR__list__request__space(list, sizeof(COMPILER__namespace), &(*error).memory_error_occured);

    // append data
    (*(COMPILER__namespace*)SAILOR__calculate__list_current_address(list)) = data;
...
void COMPILER__append__parsling_argument(SAILOR__list* list, COMPILER__parsling_argument data, COMPILER__error* error) {
    // request space
    SAILOR__list__request__space(list, sizeof(COMPILER__parsling_argument), &(*error).memory_error_occured);

    // append data
    (*(COMPILER__parsling_argument*)SAILOR__calculate__list_current_address(list)) = data;
...
void COMPILER__append__parsling_statement(SAILOR__list* list, COMPILER__parsling_statement data, COMPILER__error* error) {
    // request space
    SAILOR__list__request__space(list, sizeof(COMPILER__parsling_statement), &(*error).memory_error_occured);

    // append data
    (*(COMPILER__parsling_statement*)SAILOR__calculate__list_current_address(list)) = data;
...
void COMPILER__append__parsling_structure(SAILOR__list* list, COMPILER__parsling_structure data, COMPILER__error* error) {
    // request space
    SAILOR__list__request__space(list, sizeof(COMPILER__parsling_structure), &(*error).memory_error_occured);

    // append data
    (*(COMPILER__parsling_structure*)SAILOR__calculate__list_current_address(list)) = data;
...
void COMPILER__append__parsling_function(SAILOR__list* list, COMPILER__parsling_function data, COMPILER__error* error) {
    // request space
    SAILOR__list__request__space(list, sizeof(COMPILER__parsling_function), &(*error).memory_error_occured);

    // append data
    (*(COMPILER__parsling_function*)SAILOR__calculate__list_current_address(list)) = data;
...
void COMPILER__append__parsling_program(SAILOR__list* list, COMPILER__parsling_program data, COMPILER__error* error) {
    // request space
    SAILOR__list__request__space(list, sizeof(COMPILER__parsling_program), &(*error).memory_error_occured);

    // append data
    (*(COMPILER__parsling_program*)SAILOR__calculate__list_current_address(list)) = data;
...
void COMPILER__close__parsling_namespace(COMPILER__namespace name) {
    // close list
    SAILOR__close__counted_list(name.lexlings);
...
void COMPILER__close__parsling_argument(COMPILER__parsling_argument argument) {
    ...
    if (SAILOR__check__empty_list(argument.type.lexlings.list) == SAILOR__bt__false) {
        COMPILER__close__parsling_namespace(argument.type);
    }
    if (SAILOR__check__empty_list(argument.tag.lexlings.list) == SAILOR__bt__false) {
...
// close arguments
void COMPILER__close__parsling_arguments(SAILOR__counted_list* arguments) {
    SAILOR__current current = SAILOR__calculate__current_from_list_filled_index(&(*arguments).list);
    ...
    SAILOR__close__counted_list(*arguments);

    return;
}

// forward declaration
void COMPILER__close__parsling_statements(SAILOR__counted_list*);

// close scope
void COMPILER__close__parsling_scope(COMPILER__parsling_scope scope) {
    // close statements
    if (SAILOR__check__empty_list(scope.statements.list) == SAILOR__bt__false) {
        // close statements
...
void COMPILER__close__parsling_statement(COMPILER__parsling_statement statement) {
    ...
    // close io
    if (SAILOR__check__empty_list(statement.inputs.list) == SAILOR__bt__false) {
        COMPILER__close__parsling_arguments(&statement.inputs);
    }
    if (SAILOR__check__empty_list(statement.outputs.list) == SAILOR__bt__false) {
...
// close statements
void COMPILER__close__parsling_statements(SAILOR__counted_list* list) {
    SAILOR__current current_statement = SAILOR__calculate__current_from_list_filled_index(&(*list).list);
    ...
    SAILOR__close__counted_list(*list);
...
void COMPILER__close__parsling_program(COMPILER__parsling_program program) {
    SAILOR__current current = SAILOR__calculate__current_from_list_filled_index(&program.functions.list);
    ...
    // next current
    current = SAILOR__calculate__current_from_list_filled_index(&program.structures.list);
    ...
    // free the lists
    SAILOR__close__counted_list(program.functions);
    SAILOR__close__counted_list(program.structures);

    return;
}

// advance the current buffer by N number of lexlings
void COMPILER__advance__lexling_current(SAILOR__current* current, COMPILER__lexling_index lexling_count) {
    // advance the pointer
...
void COMPILER__revert__lexling_current(SAILOR__current* current, COMPILER__lexling_index lexling_count) {
    (*current).start -= sizeof(COMPILER__lexling) * lexling_count;
...
COMPILER__namespace COMPILER__parse__namespace__one_name_only(SAILOR__current* current, COMPILER__error* error) {
    COMPILER__namespace output;
    ...
    // check for name
    if (SAILOR__check__current_within_range(*current) && COMPILER__read__lexling_from_current(*current).type == COMPILER__lt__name) {
        // append lexling
...
// parse namespace
COMPILER__namespace COMPILER__parse__namespace(SAILOR__current* current, COMPILER__error* error) {
    COMPILER__namespace output;
    ...
    if (SAILOR__check__current_within_range(*current) && COMPILER__read__lexling_from_current(*current).type == COMPILER__lt__name) {
        ...
        // get other lexlings
        while (SAILOR__check__current_within_range(*current) && COMPILER__read__lexling_from_current(*current).type == COMPILER__lt__colon) {
            // skip past colon
            COMPILER__advance__lexling_current(current, 1);
    ...
    // if it is a string
    } else if (SAILOR__check__current_within_range(*current) && COMPILER__read__lexling_from_current(*current).type == COMPILER__lt__string_literal) {
        // append string
        COMPILER__append__lexling(&output.lexlings.list, COMPILER__read__lexling_from_current(*current), error);
        if (COMPILER__check__error_occured(error)) {
            return output;
...
// parse one argument
COMPILER__parsling_argument COMPILER__parse__statement_argument(SAILOR__current* current, COMPILER__palt argument_location, COMPILER__error* error) {
...
SAILOR__counted_list COMPILER__parse__statement_arguments(SAILOR__current* current, COMPILER__palt argument_location, COMPILER__error* error) {
    ...
    if (SAILOR__check__current_within_range(*current) && COMPILER__read__lexling_from_current(*current).type == COMPILER__lt__left_parenthesis) {
        // next lexling
        COMPILER__advance__lexling_current(current, 1);
    // not found, error
    } else {
    ...
    // get arguments
    while (SAILOR__check__current_within_range(*current) && COMPILER__read__lexling_from_current(*current).type != COMPILER__lt__right_parenthesis) {
    ...
    if (SAILOR__check__current_within_range(*current) && COMPILER__read__lexling_from_current(*current).type == COMPILER__lt__right_parenthesis) {
        // next lexling
        COMPILER__advance__lexling_current(current, 1);
    // not found, error
    } else {
...
// predefine
COMPILER__parsling_scope COMPILER__parse__scope(SAILOR__current* current, COMPILER__error* error);

// parse one statement
COMPILER__parsling_statement COMPILER__parse__statement(SAILOR__current* current, COMPILER__palt argument_location, COMPILER__error* error) {
    COMPILER__parsling_statement output = COMPILER__create_null__parsling_statement();
    SAILOR__bt is_scoped_offset = SAILOR__bt__false;

    // check for offset
    if (SAILOR__check__current_within_range(*current) && COMPILER__read__lexling_from_current(*current).type == COMPILER__lt__at) {
        ...
        {
            // setup temps
            SAILOR__current look_ahead_current = *current;
            ...
            if (SAILOR__check__current_within_range(look_ahead_current) && COMPILER__read__lexling_from_current(look_ahead_current).type == COMPILER__lt__equals) {
                // is a named scope
                is_scoped_offset = SAILOR__bt__true;
            }
        }

        // is a scope
        if (is_scoped_offset == SAILOR__bt__true) {
            // is a named scope
    ...
    // is a function call
    } else if (SAILOR__check__current_within_range(*current) && COMPILER__read__lexling_from_current(*current).type == COMPILER__lt__name) {
        // get name
        output.name = COMPILER__create__parsling_argument(COMPILER__pat__offset, COMPILER__parse__namespace(current, error), COMPILER__create_null__namespace(), COMPILER__create_null__namespace());
...
COMPILER__parsling_scope COMPILER__parse__scope(SAILOR__current* current, COMPILER__error* error) {
    ...
    if (SAILOR__check__current_within_range(*current) && COMPILER__read__lexling_from_current(*current).type == COMPILER__lt__left_curly_bracket) {
        // advance current
        COMPILER__advance__lexling_current(current, 1);
    ...
    // get statements
    while (SAILOR__check__current_within_range(*current) && COMPILER__read__lexling_from_current(*current).type != COMPILER__lt__right_curly_bracket) {
        // parse statement
    ...
    if (SAILOR__check__current_within_range(*current) && COMPILER__read__lexling_from_current(*current).type == COMPILER__lt__right_curly_bracket) {
        // advance current
        COMPILER__advance__lexling_current(current, 1);
    // scope opener not found, error
    } else {
...
// parse a structure
COMPILER__parsling_structure COMPILER__parse__structure(SAILOR__current* current, COMPILER__error* error) {
    ...
    // parse type names
    while (SAILOR__check__current_within_range(*current) && COMPILER__read__lexling_from_current(*current).type == COMPILER__lt__exclamation_point) {
...
// parse a function
COMPILER__parsling_function COMPILER__parse__function(SAILOR__current* current, COMPILER__error* error) {
    ...
    if (SAILOR__check__current_within_range(*current) && COMPILER__read__lexling_from_current(*current).type == COMPILER__lt__equals) {
    ...
    output.scope.inputs = SAILOR__create_null__counted_list();
    output.scope.outputs = SAILOR__create_null__counted_list();
...
COMPILER__parsling_program COMPILER__parse__program(COMPILER__lexlings lexlings, COMPILER__error* error) {
    ...
    SAILOR__current current_lexling;
    ...
    // setup current
    current_lexling = SAILOR__calculate__list_current_buffer(&lexlings.data.list);

    // parse functions & structures
    while (SAILOR__check__current_within_range(current_lexling)) {
        // if end of files
...
void COMPILER__print__namespace(COMPILER__namespace name) {
    ...
    // setup current
    current_lexling = SAILOR__calculate__current_from_list_filled_index(&name.lexlings.list);

    // print starting name lexling
    SAILOR__print__buffer(COMPILER__read__lexling_from_current(current_lexling).value);
    current_lexling.start += sizeof(COMPILER__lexling);
...
void COMPILER__print__parsling_argument(COMPILER__parsling_argument argument) {
    // print type
    printf("[");
    SAILOR__print__buffer(COMPILER__convert__general_argument_type_to_string_buffer(argument.category));
    printf("]");
...
// print arguments
void COMPILER__print__parsling_arguments(SAILOR__counted_list* arguments) {
    SAILOR__current current = SAILOR__calculate__current_from_list_filled_index(&(*arguments).list);
...
// forward declaration
void COMPILER__print__parsed_scope(COMPILER__parsling_scope scope, SAILOR__tab_count tab_depth);

// print statement
void COMPILER__print__parsed_statement(COMPILER__parsling_statement statement, SAILOR__tab_count tab_depth) {
    // print tabs
    ...
    if (statement.type == COMPILER__stt__offset) {
        ...
        // print scope
        printf("@[subscope]");
        if (COMPILER__check__empty_namespace(statement.name.name) == SAILOR__bt__false) {
            COMPILER__print__namespace(statement.name.name);
        }
        printf(" ");
        if (COMPILER__check__empty_namespace(statement.name.name) == SAILOR__bt__false) {
...
// print a scope
void COMPILER__print__parsed_scope(COMPILER__parsling_scope scope, SAILOR__tab_count tab_depth) {
    SAILOR__current current_statement = SAILOR__calculate__current_from_list_filled_index(&scope.statements.list);
...
// print a function
void COMPILER__print__parsed_function(COMPILER__parsling_function function, SAILOR__tab_count tab_depth) {
    // print header
    SAILOR__print__tabs(tab_depth);
    printf("Function: ");
...
// print a structure
void COMPILER__print__parsed_structure(COMPILER__parsling_structure structure, SAILOR__tab_count tab_depth) {
    SAILOR__current current_name = SAILOR__calculate__current_from_list_filled_index(&structure.type_names.list);
...
void COMPILER__print__parsed_program(COMPILER__parsling_program program) {
    SAILOR__current current_structure = SAILOR__calculate__current_from_list_filled_index(&program.structures.list);
    SAILOR__current current_function = SAILOR__calculate__current_from_list_filled_index(&program.functions.list);
