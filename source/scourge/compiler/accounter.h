...
ANVIL__bt COMPILER__account__functions__check_and_get_statement_translation__sets(COMPILER__accountling_structures structures, COMPILER__accountling_function* accountling_function, COMPILER__parsling_statement parsling_statement, COMPILER__accountling_statement* accountling_statement, COMPILER__error* error) {
    ...
    if (COMPILER__check__namespace_against_c_string(COMPILER__global__predefined_function_call_names[COMPILER__pfcnt__set], parsling_statement.name.name) && parsling_statement.inputs.count == 1 && parsling_statement.outputs.count == 1) {
        ...
        if (COMPILER__get__parsling_argument_by_index(parsling_statement.inputs, 0).category == COMPILER__pat__string_literal && COMPILER__get__parsling_argument_by_index(parsling_statement.outputs, 0).category == COMPILER__pat__name) {
            ...
            COMPILER__accountling_variable_argument variable_argument = COMPILER__account__functions__mark_variable(structures, accountling_function, COMPILER__get__parsling_argument_by_index(parsling_statement.outputs, 0), COMPILER__ptt__scourge_buffer, COMPILER__asvt__output, ANVIL__bt__true, &is_valid_argument, error);
        ...
        // check for integer literal
            ...
            if (COMPILER__translate__string_to_boolean(integer_string, &integer_value) || COMPILER__translate__string_to_binary(integer_string, &integer_value) || COMPILER__translate__string_to_integer(integer_string, &integer_value) || COMPILER__translate__string_to_hexadecimal(integer_string, &integer_value)) {
                // get index
                ANVIL__bt is_valid_argument;
                COMPILER__accountling_variable_argument variable_argument = COMPILER__account__functions__mark_variable(structures, accountling_function, COMPILER__get__parsling_argument_by_index(parsling_statement.outputs, 0), COMPILER__ptt__scourge_cell, COMPILER__asvt__output, ANVIL__bt__true, &is_valid_argument, error);
                if (COMPILER__check__error_occured(error) || variable_argument.type >= COMPILER__avat__COUNT) {
                    goto failure;
                }
...
ANVIL__bt COMPILER__account__functions__check_and_get_statement_translation__prints(COMPILER__accountling_structures structures, COMPILER__accountling_function* accountling_function, COMPILER__parsling_statement parsling_statement, COMPILER__accountling_statement* accountling_statement, COMPILER__error* error) {
    ...
    if (COMPILER__check__namespace_against_c_string(COMPILER__global__predefined_function_call_names[COMPILER__pfcnt__print__character], parsling_statement.name.name) && parsling_statement.inputs.count == 1 && parsling_statement.outputs.count == 0) {
        ...
        if (COMPILER__get__parsling_argument_by_index(parsling_statement.inputs, 0).category == COMPILER__pat__name) {
            ...
            // get index
            ANVIL__bt is_valid_argument;
            COMPILER__accountling_variable_argument variable_argument = COMPILER__account__functions__mark_variable(structures, accountling_function, COMPILER__get__parsling_argument_by_index(parsling_statement.inputs, 0), COMPILER__ptt__scourge_cell, COMPILER__asvt__input, ANVIL__bt__false, &is_valid_argument, error);
            if (COMPILER__check__error_occured(error) || variable_argument.type >= COMPILER__avat__COUNT) {
                goto failure;
            }
...
ANVIL__bt COMPILER__account__functions__check_and_get_statement_translation__increment_packers(COMPILER__accountling_structures structures, COMPILER__accountling_function* accountling_function, COMPILER__parsling_statement parsling_statement, COMPILER__accountling_statement* accountling_statement, COMPILER__error* error) {
    ...
    if (COMPILER__check__namespace_against_c_string(COMPILER__global__predefined_function_call_names[COMPILER__pfcnt__pack_increment], parsling_statement.name.name) && parsling_statement.inputs.count == 2 && parsling_statement.outputs.count == 1) {
        ...
        if (COMPILER__get__parsling_argument_by_index(parsling_statement.inputs, 0).category == COMPILER__pat__name && COMPILER__get__parsling_argument_by_index(parsling_statement.inputs, 1).category == COMPILER__pat__name && COMPILER__get__parsling_argument_by_index(parsling_statement.outputs, 0).category == COMPILER__pat__name && packing_type < structures.name_table.count) {
            // mark variables
            ANVIL__bt is_valid_argument;
            COMPILER__accountling_variable_argument increment_start_argument = COMPILER__account__functions__mark_variable(structures, accountling_function, COMPILER__get__parsling_argument_by_index(parsling_statement.inputs, 0), COMPILER__ptt__scourge_cell, COMPILER__asvt__input, ANVIL__bt__false, &is_valid_argument, error);
            if (COMPILER__check__error_occured(error) || increment_start_argument.type >= COMPILER__avat__COUNT) {
                goto failure;
            }
            COMPILER__accountling_variable_argument increment_by_argument = COMPILER__account__functions__mark_variable(structures, accountling_function, COMPILER__get__parsling_argument_by_index(parsling_statement.inputs, 1), COMPILER__ptt__scourge_cell, COMPILER__asvt__input, ANVIL__bt__false, &is_valid_argument, error);
...
ANVIL__bt COMPILER__account__functions__check_and_get_statement_translation__data_checking(COMPILER__accountling_structures structures, COMPILER__accountling_function* accountling_function, COMPILER__parsling_statement parsling_statement, COMPILER__accountling_statement* accountling_statement, COMPILER__error* error) {
    ...
    if (COMPILER__check__namespace_against_c_string(COMPILER__global__predefined_function_call_names[COMPILER__pfcnt__integer__within_range], parsling_statement.name.name) && parsling_statement.inputs.count == 3 && parsling_statement.outputs.count == 2) {
        ...
        if (COMPILER__get__parsling_argument_by_index(parsling_statement.inputs, 0).category == COMPILER__pat__name && COMPILER__get__parsling_argument_by_index(parsling_statement.inputs, 1).category == COMPILER__pat__name && COMPILER__get__parsling_argument_by_index(parsling_statement.inputs, 2).category == COMPILER__pat__name && COMPILER__get__parsling_argument_by_index(parsling_statement.outputs, 0).category == COMPILER__pat__name && COMPILER__get__parsling_argument_by_index(parsling_statement.outputs, 1).category == COMPILER__pat__name) {
            ...
            // get index
            ANVIL__bt is_valid_argument;
            COMPILER__accountling_variable_argument lower_argument = COMPILER__account__functions__mark_variable(structures, accountling_function, COMPILER__get__parsling_argument_by_index(parsling_statement.inputs, 0), COMPILER__ptt__scourge_cell, COMPILER__asvt__input, ANVIL__bt__false, &is_valid_argument, error);
            if (COMPILER__check__error_occured(error) || lower_argument.type >= COMPILER__avat__COUNT) {
                goto failure;
            }
            COMPILER__accountling_variable_argument checking_argument = COMPILER__account__functions__mark_variable(structures, accountling_function, COMPILER__get__parsling_argument_by_index(parsling_statement.inputs, 1), COMPILER__ptt__scourge_cell, COMPILER__asvt__input, ANVIL__bt__false, &is_valid_argument, error);
            if (COMPILER__check__error_occured(error) || checking_argument.type >= COMPILER__avat__COUNT) {
                goto failure;
            }
            COMPILER__accountling_variable_argument higher_argument = COMPILER__account__functions__mark_variable(structures, accountling_function, COMPILER__get__parsling_argument_by_index(parsling_statement.inputs, 2), COMPILER__ptt__scourge_cell, COMPILER__asvt__input, ANVIL__bt__false, &is_valid_argument, error);
            if (COMPILER__check__error_occured(error) || higher_argument.type >= COMPILER__avat__COUNT) {
                goto failure;
            }
            COMPILER__accountling_variable_argument result_argument = COMPILER__account__functions__mark_variable(structures, accountling_function, COMPILER__get__parsling_argument_by_index(parsling_statement.outputs, 0), COMPILER__ptt__scourge_cell, COMPILER__asvt__output, ANVIL__bt__true, &is_valid_argument, error);
            if (COMPILER__check__error_occured(error) || result_argument.type >= COMPILER__avat__COUNT) {
                goto failure;
            }
            COMPILER__accountling_variable_argument inverted_result_argument = COMPILER__account__functions__mark_variable(structures, accountling_function, COMPILER__get__parsling_argument_by_index(parsling_statement.outputs, 1), COMPILER__ptt__scourge_cell, COMPILER__asvt__output, ANVIL__bt__true, &is_valid_argument, error);
...
ANVIL__bt COMPILER__account__functions__check_and_get_statement_translation__integer_operations(COMPILER__accountling_structures structures, COMPILER__accountling_function* accountling_function, COMPILER__parsling_statement parsling_statement, COMPILER__accountling_statement* accountling_statement, COMPILER__error* error) {
    ...
    if (parsling_statement.inputs.count == 2 && parsling_statement.outputs.count == 1 && (COMPILER__check__namespace_against_c_string(COMPILER__global__predefined_function_call_names[COMPILER__pfcnt__integer__add], parsling_statement.name.name) || COMPILER__check__namespace_against_c_string(COMPILER__global__predefined_function_call_names[COMPILER__pfcnt__integer__subtract], parsling_statement.name.name) || COMPILER__check__namespace_against_c_string(COMPILER__global__predefined_function_call_names[COMPILER__pfcnt__integer__multiply], parsling_statement.name.name) || COMPILER__check__namespace_against_c_string(COMPILER__global__predefined_function_call_names[COMPILER__pfcnt__integer__divide], parsling_statement.name.name) || COMPILER__check__namespace_against_c_string(COMPILER__global__predefined_function_call_names[COMPILER__pfcnt__integer__modulous], parsling_statement.name.name))) {
        // get variables
        ANVIL__bt is_valid_argument;
        COMPILER__accountling_variable_argument first_argument = COMPILER__account__functions__mark_variable(structures, accountling_function, COMPILER__get__parsling_argument_by_index(parsling_statement.inputs, 0), COMPILER__ptt__scourge_cell, COMPILER__asvt__input, ANVIL__bt__false, &is_valid_argument, error);
        if (COMPILER__check__error_occured(error) || first_argument.type >= COMPILER__avat__COUNT) {
            goto failure;
        }
        COMPILER__accountling_variable_argument second_argument = COMPILER__account__functions__mark_variable(structures, accountling_function, COMPILER__get__parsling_argument_by_index(parsling_statement.inputs, 1), COMPILER__ptt__scourge_cell, COMPILER__asvt__input, ANVIL__bt__false, &is_valid_argument, error);
        if (COMPILER__check__error_occured(error) || second_argument.type >= COMPILER__avat__COUNT) {
            goto failure;
        }
        COMPILER__accountling_variable_argument output_argument = COMPILER__account__functions__mark_variable(structures, accountling_function, COMPILER__get__parsling_argument_by_index(parsling_statement.outputs, 0), COMPILER__ptt__scourge_cell, COMPILER__asvt__output, ANVIL__bt__true, &is_valid_argument, error);
        if (COMPILER__check__error_occured(error) || output_argument.type >= COMPILER__avat__COUNT) {
            goto failure;
        }
...
ANVIL__bt COMPILER__account__functions__check_and_get_statement_translation__bit_operations(COMPILER__accountling_structures structures, COMPILER__accountling_function* accountling_function, COMPILER__parsling_statement parsling_statement, COMPILER__accountling_statement* accountling_statement, COMPILER__error* error) {
    ...
    // if is an overwrite
        ...
        COMPILER__accountling_variable_argument third_argument = COMPILER__account__functions__mark_variable(structures, accountling_function, COMPILER__get__parsling_argument_by_index(parsling_statement.inputs, 2), COMPILER__ptt__scourge_cell, COMPILER__asvt__input, ANVIL__bt__false, &is_valid_argument, error);
...
ANVIL__bt COMPILER__account__functions__check_and_get_statement_translation__buffer_acquisition(COMPILER__accountling_structures structures, COMPILER__accountling_function* accountling_function, COMPILER__parsling_statement parsling_statement, COMPILER__accountling_statement* accountling_statement, COMPILER__error* error) {
    ...
    if (COMPILER__check__namespace_against_c_string(COMPILER__global__predefined_function_call_names[COMPILER__pfcnt__buffer__request], parsling_statement.name.name) && parsling_statement.inputs.count == 1 && parsling_statement.outputs.count == 1) {
        // get variables
        ANVIL__bt is_valid_argument;
        COMPILER__accountling_variable_argument input_argument = COMPILER__account__functions__mark_variable(structures, accountling_function, COMPILER__get__parsling_argument_by_index(parsling_statement.inputs, 0), COMPILER__ptt__scourge_cell, COMPILER__asvt__input, ANVIL__bt__false, &is_valid_argument, error);
        if (COMPILER__check__error_occured(error) || input_argument.type >= COMPILER__avat__COUNT) {
            goto failure;
        }
        COMPILER__accountling_variable_argument output_argument = COMPILER__account__functions__mark_variable(structures, accountling_function, COMPILER__get__parsling_argument_by_index(parsling_statement.outputs, 0), COMPILER__ptt__scourge_buffer, COMPILER__asvt__output, ANVIL__bt__true, &is_valid_argument, error);
        if (COMPILER__check__error_occured(error) || output_argument.type >= COMPILER__avat__COUNT) {
            goto failure;
        }
    ...
    // if is buffer return
        ...
        // get variables
        ANVIL__bt is_valid_argument;
        COMPILER__accountling_variable_argument input_argument = COMPILER__account__functions__mark_variable(structures, accountling_function, COMPILER__get__parsling_argument_by_index(parsling_statement.inputs, 0), COMPILER__ptt__scourge_buffer, COMPILER__asvt__input, ANVIL__bt__false, &is_valid_argument, error);
        if (COMPILER__check__error_occured(error) || input_argument.type >= COMPILER__avat__COUNT) {
            goto failure;
        }
...
ANVIL__bt COMPILER__account__functions__check_and_get_statement_translation__cell_address_movers(COMPILER__accountling_structures structures, COMPILER__accountling_function* accountling_function, COMPILER__parsling_statement parsling_statement, COMPILER__accountling_statement* accountling_statement, COMPILER__error* error) {
    ...
    if (COMPILER__check__namespace_against_c_string(COMPILER__global__predefined_function_call_names[COMPILER__pfcnt__buffer__address_to_cell], parsling_statement.name.name) && parsling_statement.inputs.count == 2 && parsling_statement.outputs.count == 2) {
        // get variables
        ANVIL__bt is_valid_argument;
        COMPILER__accountling_variable_argument address_argument = COMPILER__account__functions__mark_variable(structures, accountling_function, COMPILER__get__parsling_argument_by_index(parsling_statement.inputs, 0), COMPILER__ptt__scourge_cell, COMPILER__asvt__input, ANVIL__bt__false, &is_valid_argument, error);
        if (COMPILER__check__error_occured(error) || address_argument.type >= COMPILER__avat__COUNT) {
            goto failure;
        }
        COMPILER__accountling_variable_argument byte_count_argument = COMPILER__account__functions__mark_variable(structures, accountling_function, COMPILER__get__parsling_argument_by_index(parsling_statement.inputs, 1), COMPILER__ptt__scourge_cell, COMPILER__asvt__input, ANVIL__bt__false, &is_valid_argument, error);
        if (COMPILER__check__error_occured(error) || byte_count_argument.type >= COMPILER__avat__COUNT) {
            goto failure;
        }
        COMPILER__accountling_variable_argument cell_argument = COMPILER__account__functions__mark_variable(structures, accountling_function, COMPILER__get__parsling_argument_by_index(parsling_statement.outputs, 0), COMPILER__ptt__scourge_cell, COMPILER__asvt__output, ANVIL__bt__true, &is_valid_argument, error);
        if (COMPILER__check__error_occured(error) || cell_argument.type >= COMPILER__avat__COUNT) {
            goto failure;
        }
        COMPILER__accountling_variable_argument advancement_argument = COMPILER__account__functions__mark_variable(structures, accountling_function, COMPILER__get__parsling_argument_by_index(parsling_statement.outputs, 1), COMPILER__ptt__scourge_cell, COMPILER__asvt__output, ANVIL__bt__true, &is_valid_argument, error);
    ...
    // if is cell to address
        ...
        // get variables
        ANVIL__bt is_valid_argument;
        COMPILER__accountling_variable_argument cell_argument = COMPILER__account__functions__mark_variable(structures, accountling_function, COMPILER__get__parsling_argument_by_index(parsling_statement.inputs, 0), COMPILER__ptt__scourge_cell, COMPILER__asvt__input, ANVIL__bt__false, &is_valid_argument, error);
        if (COMPILER__check__error_occured(error) || cell_argument.type >= COMPILER__avat__COUNT) {
            goto failure;
        }
        COMPILER__accountling_variable_argument byte_count_argument = COMPILER__account__functions__mark_variable(structures, accountling_function, COMPILER__get__parsling_argument_by_index(parsling_statement.inputs, 1), COMPILER__ptt__scourge_cell, COMPILER__asvt__input, ANVIL__bt__false, &is_valid_argument, error);
        ...
        COMPILER__accountling_variable_argument address_argument = COMPILER__account__functions__mark_variable(structures, accountling_function, COMPILER__get__parsling_argument_by_index(parsling_statement.inputs, 2), COMPILER__ptt__scourge_cell, COMPILER__asvt__input, ANVIL__bt__false, &is_valid_argument, error);
        if (COMPILER__check__error_occured(error) || address_argument.type >= COMPILER__avat__COUNT) {
            goto failure;
        }
        COMPILER__accountling_variable_argument advancement_argument = COMPILER__account__functions__mark_variable(structures, accountling_function, COMPILER__get__parsling_argument_by_index(parsling_statement.outputs, 0), COMPILER__ptt__scourge_cell, COMPILER__asvt__output, ANVIL__bt__true, &is_valid_argument, error);
        if (COMPILER__check__error_occured(error) || advancement_argument.type >= COMPILER__avat__COUNT) {
            goto failure;
        }
...
ANVIL__bt COMPILER__account__functions__check_and_get_statement_translation__file_buffer_movers(COMPILER__accountling_structures structures, COMPILER__accountling_function* accountling_function, COMPILER__parsling_statement parsling_statement, COMPILER__accountling_statement* accountling_statement, COMPILER__error* error) {
    ...
    if (COMPILER__check__namespace_against_c_string(COMPILER__global__predefined_function_call_names[COMPILER__pfcnt__buffer__file_to_buffer], parsling_statement.name.name) && parsling_statement.inputs.count == 1 && parsling_statement.outputs.count == 1) {
        // get variables
        ANVIL__bt is_valid_argument;
        COMPILER__accountling_variable_argument file_path_argument = COMPILER__account__functions__mark_variable(structures, accountling_function, COMPILER__get__parsling_argument_by_index(parsling_statement.inputs, 0), COMPILER__ptt__scourge_buffer, COMPILER__asvt__input, ANVIL__bt__false, &is_valid_argument, error);
        if (COMPILER__check__error_occured(error) || file_path_argument.type >= COMPILER__avat__COUNT) {
            goto failure;
        }
        COMPILER__accountling_variable_argument buffer_argument = COMPILER__account__functions__mark_variable(structures, accountling_function, COMPILER__get__parsling_argument_by_index(parsling_statement.outputs, 0), COMPILER__ptt__scourge_buffer, COMPILER__asvt__output, ANVIL__bt__true, &is_valid_argument, error);
    ...
    // if is buffer to file
        ...
        // get variables
        ANVIL__bt is_valid_argument;
        COMPILER__accountling_variable_argument buffer_argument = COMPILER__account__functions__mark_variable(structures, accountling_function, COMPILER__get__parsling_argument_by_index(parsling_statement.inputs, 0), COMPILER__ptt__scourge_buffer, COMPILER__asvt__input, ANVIL__bt__false, &is_valid_argument, error);
        if (COMPILER__check__error_occured(error) || buffer_argument.type >= COMPILER__avat__COUNT) {
            goto failure;
        }
        COMPILER__accountling_variable_argument file_path_argument = COMPILER__account__functions__mark_variable(structures, accountling_function, COMPILER__get__parsling_argument_by_index(parsling_statement.inputs, 1), COMPILER__ptt__scourge_buffer, COMPILER__asvt__input, ANVIL__bt__false, &is_valid_argument, error);
        if (COMPILER__check__error_occured(error) || file_path_argument.type >= COMPILER__avat__COUNT) {
            goto failure;
        }
    ...
    // if is buffer copy low to high
        ...
        // get variables
        ANVIL__bt is_valid_argument;
        COMPILER__accountling_variable_argument first_buffer_argument = COMPILER__account__functions__mark_variable(structures, accountling_function, COMPILER__get__parsling_argument_by_index(parsling_statement.inputs, 0), COMPILER__ptt__scourge_buffer, COMPILER__asvt__input, ANVIL__bt__false, &is_valid_argument, error);
        if (COMPILER__check__error_occured(error) || first_buffer_argument.type >= COMPILER__avat__COUNT) {
            goto failure;
        }
        COMPILER__accountling_variable_argument second_buffer_argument = COMPILER__account__functions__mark_variable(structures, accountling_function, COMPILER__get__parsling_argument_by_index(parsling_statement.inputs, 1), COMPILER__ptt__scourge_buffer, COMPILER__asvt__input, ANVIL__bt__false, &is_valid_argument, error);
...
ANVIL__bt COMPILER__account__functions__check_and_get_statement_translation__structure_buffer_movers(COMPILER__accountling_structures structures, COMPILER__accountling_function* accountling_function, COMPILER__parsling_statement parsling_statement, COMPILER__accountling_statement* accountling_statement, COMPILER__error* error) {
    ...
    if (COMPILER__check__namespace_against_c_string(COMPILER__global__predefined_function_call_names[COMPILER__pfcnt__structure__structure_byte_size], parsling_statement.name.name) && parsling_statement.inputs.count == 1 && parsling_statement.outputs.count == 1) {
        ...
        COMPILER__accountling_variable_argument size_argument = COMPILER__account__functions__mark_variable(structures, accountling_function, COMPILER__get__parsling_argument_by_index(parsling_statement.outputs, 0), COMPILER__ptt__scourge_cell, COMPILER__asvt__output, ANVIL__bt__true, &is_valid_argument, error);
    ...
    // if is structure to buffer
        ...
        COMPILER__accountling_variable_argument buffer_argument = COMPILER__account__functions__mark_variable(structures, accountling_function, COMPILER__get__parsling_argument_by_index(parsling_statement.inputs, 1), COMPILER__ptt__scourge_buffer, COMPILER__asvt__input, ANVIL__bt__false, &is_valid_argument, error);
        if (COMPILER__check__error_occured(error) || buffer_argument.type >= COMPILER__avat__COUNT) {
            goto failure;
        }
        COMPILER__accountling_variable_argument advancement_argument = COMPILER__account__functions__mark_variable(structures, accountling_function, COMPILER__get__parsling_argument_by_index(parsling_statement.outputs, 0), COMPILER__ptt__scourge_cell, COMPILER__asvt__output, ANVIL__bt__true, &is_valid_argument, error);
...
ANVIL__bt COMPILER__account__functions__check_and_get_statement_translation__compiler_assorted(COMPILER__accountling_structures structures, COMPILER__accountling_function* accountling_function, COMPILER__parsling_statement parsling_statement, COMPILER__accountling_statement* accountling_statement, COMPILER__error* error) {
    ...
    if (COMPILER__check__namespace_against_c_string(COMPILER__global__predefined_function_call_names[COMPILER__pfcnt__compiler__compile], parsling_statement.name.name) && parsling_statement.inputs.count == 2 && parsling_statement.outputs.count == 3) {
        ...
        COMPILER__accountling_variable_argument error_information_argument = COMPILER__account__functions__mark_variable(structures, accountling_function, COMPILER__get__parsling_argument_by_index(parsling_statement.outputs, 2), COMPILER__ptt__scourge_compiler__error, COMPILER__asvt__output, ANVIL__bt__true, &is_valid_argument, error);
...
ANVIL__bt COMPILER__account__functions__check_and_get_statement_translation__context_assorted(COMPILER__accountling_structures structures, COMPILER__accountling_function* accountling_function, COMPILER__parsling_statement parsling_statement, COMPILER__accountling_statement* accountling_statement, COMPILER__error* error) {
    ...
    if (COMPILER__check__namespace_against_c_string(COMPILER__global__predefined_function_call_names[COMPILER__pfcnt__context__install_program], parsling_statement.name.name) && parsling_statement.inputs.count == 2 && parsling_statement.outputs.count == 0) {
        ...
        // get index
        ANVIL__bt is_valid_argument;
        COMPILER__accountling_variable_argument context_argument = COMPILER__account__functions__mark_variable(structures, accountling_function, COMPILER__get__parsling_argument_by_index(parsling_statement.inputs, 0), COMPILER__ptt__scourge_buffer, COMPILER__asvt__input, ANVIL__bt__false, &is_valid_argument, error);
        if (COMPILER__check__error_occured(error) || context_argument.type >= COMPILER__avat__COUNT) {
            goto failure;
        }
        COMPILER__accountling_variable_argument program_argument = COMPILER__account__functions__mark_variable(structures, accountling_function, COMPILER__get__parsling_argument_by_index(parsling_statement.inputs, 1), COMPILER__ptt__scourge_buffer, COMPILER__asvt__input, ANVIL__bt__false, &is_valid_argument, error);
...
ANVIL__bt COMPILER__account__functions__check_and_get_statement_translation__time_functions(COMPILER__accountling_structures structures, COMPILER__accountling_function* accountling_function, COMPILER__parsling_statement parsling_statement, COMPILER__accountling_statement* accountling_statement, COMPILER__error* error) {
    ...
    if (COMPILER__check__namespace_against_c_string(COMPILER__global__predefined_function_call_names[COMPILER__pfcnt__time__now], parsling_statement.name.name) && parsling_statement.inputs.count == 0 && parsling_statement.outputs.count == 1) {
        ...
        // get index
        ANVIL__bt is_valid_argument;
        COMPILER__accountling_variable_argument output_argument = COMPILER__account__functions__mark_variable(structures, accountling_function, COMPILER__get__parsling_argument_by_index(parsling_statement.outputs, 0), COMPILER__ptt__scourge_time, COMPILER__asvt__output, ANVIL__bt__true, &is_valid_argument, error);
        if (COMPILER__check__error_occured(error) || output_argument.type >= COMPILER__avat__COUNT) {
            goto failure;
        }
...
ANVIL__bt COMPILER__account__functions__check_and_get_statement_translation__allocation_related_functions(COMPILER__accountling_structures structures, COMPILER__accountling_function* accountling_function, COMPILER__parsling_statement parsling_statement, COMPILER__accountling_statement* accountling_statement, COMPILER__error* error) {
    ...
    if (COMPILER__check__namespace_against_c_string(COMPILER__global__predefined_function_call_names[COMPILER__pfcnt__buffer__find_allocation], parsling_statement.name.name) && parsling_statement.inputs.count == 1 && parsling_statement.outputs.count == 2) {
        ...
        // get index
        ANVIL__bt is_valid_argument;
        COMPILER__accountling_variable_argument source_argument = COMPILER__account__functions__mark_variable(structures, accountling_function, COMPILER__get__parsling_argument_by_index(parsling_statement.inputs, 0), COMPILER__ptt__scourge_buffer, COMPILER__asvt__input, ANVIL__bt__false, &is_valid_argument, error);
        if (COMPILER__check__error_occured(error) || source_argument.type >= COMPILER__avat__COUNT) {
            goto failure;
        }
        COMPILER__accountling_variable_argument was_found_argument = COMPILER__account__functions__mark_variable(structures, accountling_function, COMPILER__get__parsling_argument_by_index(parsling_statement.outputs, 0), COMPILER__ptt__scourge_cell, COMPILER__asvt__output, ANVIL__bt__true, &is_valid_argument, error);
        if (COMPILER__check__error_occured(error) || was_found_argument.type >= COMPILER__avat__COUNT) {
            goto failure;
        }
        COMPILER__accountling_variable_argument found_argument = COMPILER__account__functions__mark_variable(structures, accountling_function, COMPILER__get__parsling_argument_by_index(parsling_statement.outputs, 1), COMPILER__ptt__scourge_buffer, COMPILER__asvt__output, ANVIL__bt__true, &is_valid_argument, error);
...
void COMPILER__account__functions__function_sequential_information__one_scope(COMPILER__accountling_structures structures, COMPILER__accountling_function_headers function_headers, COMPILER__accountling_function* accountling_function, COMPILER__accountling_scope* accountling_scope, COMPILER__parsling_statement parsling_source_statement, COMPILER__error* error) {
    ...
    if (COMPILER__check__empty_namespace(parsling_source_statement.name.name) == ANVIL__bt__false) {
        ANVIL__bt is_valid_argument;
        (*accountling_scope).condition = COMPILER__account__functions__mark_variable(structures, accountling_function, parsling_source_statement.subscope_flag_name, COMPILER__ptt__scourge_cell, COMPILER__asvt__input, ANVIL__bt__false, &is_valid_argument, error);
        if (COMPILER__check__error_occured(error)) {
            return;
        }
        if (is_valid_argument == ANVIL__bt__false) {
